<?php
	...
	//#
	//# See include/kcaptcha_config-inc.php for customization
	//#------------------------------------------------------------------
	//# $Source: /home/jbowes/ggsdinfo/src/php/root/RCS/kcaptcha.php,v $
	//# $Id: kcaptcha.php,v 1.2 2022/12/12 19:15:32 jbowes Exp $
	//#------------------------------------------------------------------
...
class KCAPTCHA{
	...
	function __construct(){ // new PHP declaration
		...
		require(dirname(__FILE__).'/include/kcaptcha_config-inc.php');
		$fonts=array();
